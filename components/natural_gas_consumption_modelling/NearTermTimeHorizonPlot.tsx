...
export const NearTermTimeHorizonPlot = (props: any) => {
  ...
  React.useEffect(() => {
    ...
    const ctx = document.getElementById("near-term-time-horizon-natural-gas-chart") as HTMLCanvasElement;
      ...
      options: {
        ...
        scales: {
          x: {
            ...
            min: historicConsumptionData[historicConsumptionData.length - 7].x,
            max: forecastConsumptionData[14].x,
          },
          consumptionScale: {
            type: "linear",
            display: true,
  ...
  return (
    <div  className="mb-14">
      <canvas id="near-term-time-horizon-natural-gas-chart" ref={chartRef} className="w-full" />
